...
<c:out value="<a href='${return}'>Return to list</a>" escapeXml="false"/>
<title>Reservations for:
	<c:out value="${room.floor.building.name}"/> 
	<c:out value="${room.floor.name}"/> 
	<c:out value="${room.title}"/></title>
...
<display:table name="reservations" class="table" requestURI="" id="room" export="true" pagesize="10">
    ...
    <display:column href="reservationform.html?dest=reservations.html" media="html" paramId="id" paramProperty="id">Edit</display:column>
